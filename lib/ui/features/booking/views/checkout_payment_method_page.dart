...
class CheckoutPaymentMethodPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CheckoutPaymentMethodPage> createState() =>
      _CheckoutPaymentMethodPageState();
}

class _CheckoutPaymentMethodPageState extends ConsumerState<CheckoutPaymentMethodPage> {


  @override
  Widget build(BuildContext context) {
    final selectedMethod = ref.watch(bookingViewModelProvider).selectedPaymentMethodIndex;
    return Scaffold(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildPaymentOption(
                      index: 0,
                      icon: _buildCashIcon(isSelected: selectedMethod == 0),
                      title: 'Tunai (Cash)',
                      subtitle:
                    ...
                    _buildPaymentOption(
                      index: 1,
                      icon: _buildCreditIcon(isSelected: selectedMethod == 1),
  ...
  Widget _buildPaymentOption({
    ...
    final bool isSelected = ref.watch(bookingViewModelProvider).selectedPaymentMethodIndex == index;

    return GestureDetector(
      onTap: () {
        ref.read(bookingViewModelProvider.notifier).updateSelectedPaymentMethodIndex(index);
      },
  ...
  Widget _buildBenefitBox() {
    final isCash = ref.watch(bookingViewModelProvider).selectedPaymentMethodIndex == 0;
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(12),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  final selectedMethod = ref.read(bookingViewModelProvider).selectedPaymentMethodIndex;
                  if (selectedMethod == 1) {
                    context.push('/simulasi-kredit', extra: widget.motor);
                    return;
                  }

                  context.push('/booking-form', extra: widget.motor);
                },
