...
mixin _$NewsArticle {
 ...
 int get id; String get title; String get body; List<String> get tags;@JsonKey(readValue: _readReactions) int get reactions;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,const DeepCollectionEquality().hash(tags),reactions);

@override
String toString() {
  return 'NewsArticle(id: $id, title: $title, body: $body, tags: $tags, reactions: $reactions)';
}
...
@useResult
$Res call({
 int id, String title, String body, List<String> tags,@JsonKey(readValue: _readReactions) int reactions
});
...
/// Create a copy of NewsArticle
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? body = null,Object? tags = null,Object? reactions = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String body,  List<String> tags, @JsonKey(readValue: _readReactions)  int reactions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NewsArticle() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.tags,_that.reactions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String body,  List<String> tags, @JsonKey(readValue: _readReactions)  int reactions)  $default,) {final _that = this;
switch (_that) {
case _NewsArticle():
return $default(_that.id,_that.title,_that.body,_that.tags,_that.reactions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String body,  List<String> tags, @JsonKey(readValue: _readReactions)  int reactions)?  $default,) {final _that = this;
switch (_that) {
case _NewsArticle() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.tags,_that.reactions);case _:
  return null;
...
class _NewsArticle implements NewsArticle {
  const _NewsArticle({required this.id, required this.title, required this.body, final  List<String> tags = const [], @JsonKey(readValue: _readReactions) this.reactions = 0}): _tags = tags;
...
@override@JsonKey(readValue: _readReactions) final  int reactions;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,const DeepCollectionEquality().hash(_tags),reactions);
...
/// Create a copy of NewsArticle
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? body = null,Object? tags = null,Object? reactions = null,}) {
